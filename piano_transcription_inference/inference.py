...
class PianoTranscription(object):
    def __init__(self,note_onoff, frame, model_type='Note_pedal',  checkpoint_path=None, 
        ...
        self.onset_threshold = note_onoff
        self.offset_threshod = note_onoff
        self.frame_threshold = frame
